...
const EmptyCartUI = () => (
	<motion.div
		className='flex flex-col items-center justify-center space-y-5 py-20 px-4 text-center bg-gray-800 rounded-xl shadow-lg'
	...
	>
		...
		<Link
			to='/'
			className='inline-block mt-4 rounded-lg bg-emerald-500 px-6 py-3 text-white text-sm font-medium hover:bg-emerald-600 transition'
		>
			← Start Shopping
		</Link>
	</motion.div>
