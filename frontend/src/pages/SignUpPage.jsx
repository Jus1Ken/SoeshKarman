			...
			>
				<div className="bg-white border border-brown-200 py-8 px-4 shadow sm:rounded-lg sm:px-10">
					<form onSubmit={handleSubmit} className="space-y-6">
						<div>
							<label htmlFor="name" className="block text-sm font-medium text-brown-600">
								Nama
							</label>
							<div className="mt-1 relative rounded-md shadow-sm">
								<div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
									<User className="h-5 w-5 text-brown-400" aria-hidden="true" />
								</div>
								<input
									id="name"
									type="text"
									...
									className="block w-full px-3 py-2 pl-10 bg-white border border-brown-300 rounded-md shadow-sm placeholder-brown-300 focus:outline-none focus:ring-brown-500 focus:border-brown-500 sm:text-sm"
						...
						<div>
							<label htmlFor="confirmPassword" className="block text-sm font-medium text-brown-600">
								Konfirmasi Password
							</label>
							<div className="mt-1 relative rounded-md shadow-sm">
								<div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
					...
					<p className="mt-8 text-center text-sm text-brown-500">
						...
						>
							Login Disini <ArrowRight className="inline h-4 w-4" />
						</Link>
					</p>
				</div>
			</motion.div>
